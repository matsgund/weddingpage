            ...
            <div className="w-full py-12 px-4 lg:py-36 text-center bg-white">
                ...
                <Fade
                    ...
                    <div className="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        <a href="https://onskelister.no/liste?id=9DJpBGcRBSvyvAZ3glRX" className="w-full sm:w-auto bg-primary hover:bg-secondary focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-md inline-flex items-center justify-center px-4 py-2.5 ">
